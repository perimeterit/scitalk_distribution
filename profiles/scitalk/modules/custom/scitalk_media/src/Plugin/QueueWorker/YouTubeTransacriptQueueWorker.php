    ...
    if (!empty($data)) {
      ...
      if (!empty($entity)) {
        try {
          ...
          $this->logger->notice('TranscriptsDisabledException <br>File: @f, <br>Line @l', [
                '@f' => $e->getFile(),
                '@l' => $e->getLine()
            ]);
        }
          ...
          //no trascript, remove from queue and continue
          $this->logger->notice('NoTranscriptAvailableException <br>File: @f, <br>Line @l', [
                '@f' => $e->getFile(),
                '@l' => $e->getLine()
            ]);
        }
          ...
          $this->logger->error('Code @e,  <br>File: @f, <br>Line @l, <br>Trace @t', [
                '@e' => $e->getCode(),
                '@f' => $e->getFile(),
                '@l' => $e->getLine(),
