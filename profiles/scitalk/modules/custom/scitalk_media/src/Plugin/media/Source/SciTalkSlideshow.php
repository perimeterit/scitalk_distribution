...
// /**
//  * Scitalk SlideShow entity media source.
//  */
// #[MediaSource(
//   id: "scitalk_slideshow",
//   label: new TranslatableMarkup("Scitalk SlideShow"),
//   description: new TranslatableMarkup("Use as a collection of Slide Items."),
//   allowed_field_types: ["string", "string_long", "link"],
// )]

/**
 * Scitalk DOI entity media source.
 *
 * @MediaSource(
 *   id = "scitalk_slideshow",
 *   label = @Translation("Scitalk SlideShow"),
 *   allowed_field_types = {"string", "string_long", "link"},  
 *   description = @Translation("Use as a collection of Slide Items.")
 * )
 */
 class SciTalkSlideshow extends MediaSourceBase implements MediaSourceFieldConstraintsInterface {
  ...
  public function createSourceField(MediaTypeInterface $type) {
    //this label shows up as the created field's name when you create a media type of SciTalk SlideShow
    //machine name auto-generated
    
    return parent::createSourceField($type)
      ->set('label', 'SlideShow URL');
  }
}
