...
/**
 * PIRSA remote file media source.
 *
 * @MediaSource(
 *   id = "scitalk_remote_file",
 *   label = @Translation("SciTalk remote file"),
 *   allowed_field_types = {"string", "string_long", "link"},  
 *   description = @Translation("Attach a link to an external file")
 * )
 */
 class SciTalkRemoteFile extends MediaSourceBase implements MediaSourceFieldConstraintsInterface {
  ...
  public function createSourceField(MediaTypeInterface $type) {
    //this label shows up as the created field's name when you create a media type of SciTalk DOI
    //machine name auto-generated
    
    return parent::createSourceField($type)
      ->set('label', 'Remote file');
  }
