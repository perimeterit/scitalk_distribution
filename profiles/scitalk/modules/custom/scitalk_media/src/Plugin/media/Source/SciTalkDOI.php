 ...
 * @MediaSource(
 *   id = "scitalk_doi",
 *   label = @Translation("SciTalk DOI"),
 *   allowed_field_types = {"string", "string_long", "link"},
 *   default_thumbnail_filename = "crossref.png",   
 *   description = @Translation("Provides business logic and metadata for SciTalk DOI.")
 * )
 */
 class SciTalkDOI extends MediaSourceBase implements MediaSourceFieldConstraintsInterface {
