...
/**
 * Scitalk Transcript text entity media source.
 *
 * @MediaSource(
 *   id = "scitalk_transcript",
 *   label = @Translation("SciVideos Transcript"),
 *   allowed_field_types = {"text_long"},
 *   description = @Translation("Provides business logic and metadata for SciTalk Transcript.")
 * )
 */
 class SciTalkTranscript extends MediaSourceBase implements MediaSourceFieldConstraintsInterface {
  ...
  public function createSourceField(MediaTypeInterface $type) {
    //this label shows up as the created field's name when you create a media type of SciTalk Transcript text
    //machine name auto-generated
    
    return parent::createSourceField($type)
      ->set('label', 'SciVideos Transcript');
  }
