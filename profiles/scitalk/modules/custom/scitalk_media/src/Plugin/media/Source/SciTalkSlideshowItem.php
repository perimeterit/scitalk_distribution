...
/**
 * Scitalk SlideShow item entity media source.
 */
#[MediaSource(
  id: "scitalk_slideshow_item",
  label: new TranslatableMarkup("SciTalk SlideShow Item"),
  description: new TranslatableMarkup("Add a Slode Item to a SlideShow."),
  allowed_field_types: ["string", "string_long", "link"],
)]
 class SciTalkSlideshowItem extends MediaSourceBase implements MediaSourceFieldConstraintsInterface {
  ...
  public function createSourceField(MediaTypeInterface $type) {
    ...
    return parent::createSourceField($type)
      ->set('label', 'SlideShow Item');
  }

  protected function getThumbnail(MediaInterface $media) {
