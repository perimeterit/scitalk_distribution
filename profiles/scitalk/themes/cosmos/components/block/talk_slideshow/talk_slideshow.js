document.addEventListener("DOMContentLoaded", () => {
  ...
  const cards = document.querySelectorAll(".talk-slideshow-card img");

  const slideModal = (function () {
    const modal = document.getElementById("slideshow-modal");
    const sliderContainer = document.querySelector(".talk-slideshow-container");
    const modalImg = document.querySelector(".slideshow-modal-content");
    const modalCaptionText = document.querySelector(".slideshow-modal-caption");
    const modalClose = document.querySelector("#slideshow-modal .slideshow-modal-close");
    const modalPrev = document.querySelector(".slideshow-modal-body .prev");
    const modalNext = document.querySelector(".slideshow-modal-body .next");
    const modalBody = document.querySelector(".slideshow-modal-body");
    ...
    function showModal(card_el) {
      ...
      modalImg.src = card_el.target.dataset.thumbnailPath;
      modalCaptionText.innerHTML = "<h4>" + card_el.target.alt + "</h4>";
    ...
    function isCard(el) {
      return el?.parentNode?.classList.contains("talk-slideshow-card");
    }
