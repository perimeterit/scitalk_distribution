/* original source at: https://www.npmjs.com/package/videojs-preroll-v2?activeTab=code */
/* cdn:  //cdn.jsdelivr.net/npm/videojs-preroll-v2@2.0.0/dist/videojs-preroll-v2.min.js */

/*! @name videojs-preroll-v2 @version 2.0.0 @license MIT */
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? (module.exports = factory(require("video.js"), require("global/window")))
  ...
  var startPrerollAd = function startPrerollAd(player, options) {
    ...
    player.preroll.timeremaining = function (e) {
      ...
      if (timeLeft > 0) {
        player.preroll.remainingTime.innerHTML =
          player.preroll.options.lang["video start in"] + timeLeft + "s";
      }
    };
  ...
  var preroll = function preroll(options) {
    startPrerollAd(
      this,
      videojs__default["default"].obj.merge(defaults, options)
    );
  }; // Register the plugin with video.js.
